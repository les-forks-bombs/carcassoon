...
SDL_AppResult SDL_AppIterate(void* appstate) {
  ...
  /* you have to draw the whole window every frame. Clearing it makes sure the
   * whole thing is sane. */
...
SDL_AppResult SDL_AppInit(void** appstate, int argc, char* argv[]) {
  SDL_SetAppMetadata("Carcassonne", "1.0",
                     "eu.telecomnancy.ppii.fork-bombs.carcassonne");
  ...
  if (!SDL_CreateWindowAndRenderer("Carcassonne", 640, 480,
