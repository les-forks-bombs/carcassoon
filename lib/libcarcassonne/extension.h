...
struct extension_process_hook {
  ...
  /// @brief Fonctin permettant de lister les actions possibles pour le joueur courant
...
struct extension {
  ...
  /// @brief Vecteur des prototypes de tuile de départ présentes dans l'extension 
  ...
  /// @brief Vecteur du nombre de meeple par joueur par type de meeple de l'extension
