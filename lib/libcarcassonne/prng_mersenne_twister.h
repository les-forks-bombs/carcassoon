...
#define LIBCARCASSONNE_PRNG_LMASK (0xffffffffUL >> (LIBCARCASSONNE_PRNG_w-LIBCARCASSONNE_PRNG_r))
...
{
    unsigned int state_array[LIBCARCASSONNE_PRNG_n];         // the array for the state vector 
